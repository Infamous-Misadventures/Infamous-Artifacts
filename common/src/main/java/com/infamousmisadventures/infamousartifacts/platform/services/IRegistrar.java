...
public interface IRegistrar {
    ...
    /**
     * Main method for this service interface, called in {@link InfamousArtifacts} in order to load it and its loader-specific implementations accordingly. Should NOT be called anywhere else!
     */
    void setupRegistrar();
     ...
     *
     * @param id The id of the object to register, following Minecraft's regex naming conventions/constraints (<code>[a-z0-9_.-]</code>). Duplicate exceptions and other edge-cases are handled accordingly
