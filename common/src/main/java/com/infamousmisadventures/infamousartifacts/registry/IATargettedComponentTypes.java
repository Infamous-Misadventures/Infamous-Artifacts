...
import com.infamousmisadventures.infamousartifacts.item.artifact.config.component.targetted.SpawnItemTargettedComponent;
...
public class IATargettedComponentTypes {
    ...
    public static final TargettedComponentType<SpawnItemTargettedComponent> SPAWN_ITEM = register("spawn_item",SpawnItemTargettedComponent.CODEC);
